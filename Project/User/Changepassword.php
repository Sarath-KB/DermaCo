...
{
	$sel="select * from tbl_user where user_id='".$_SESSION["uid"]."' and user_password='".$_POST["txt"]."'";
	$data=mysql_query($sel);
	if($row=mysql_fetch_array($data))
	{
		if($_POST["txt1"]==$_POST["txt2"])
		{
			$update="update tbl_user set user_password='".$_POST["txt1"]."' where user_id='".$_SESSION["uid"]."'";
			mysql_query($update);
