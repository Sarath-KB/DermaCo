        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="HomePage.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Home</a>
                    <!-- <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Elements</a>
                        <div class="dropdown-menu bg-transparent border-0">
                        <a href="BranchRegistration.php" class="dropdown-item">Branch Registration</a>
                    ...
                    <a href="BranchRegistration.php" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i>Branch </a>
                    <a href="District.php" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i>District</a>
                    <a href="Place.php" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i>Place</a>
                    <a href="Location.php" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i>Location</a>
                    <!-- <div class="nav-item dropdown">
